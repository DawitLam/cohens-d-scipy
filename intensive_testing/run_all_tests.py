...
def main():
    ...
    for filename, name in test_modules:
        ...
        if os.path.exists(module_path):
            ...
            print(f"⚠️ Module {filename} not found")
    ...
    if passed == total:
        ...
        print(f"⚠️ {total - passed} test module(s) failed")
